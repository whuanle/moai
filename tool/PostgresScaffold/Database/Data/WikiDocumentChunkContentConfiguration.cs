...
/// 文档切片内容.
/// </summary>
internal partial class WikiDocumentChunkContentConfiguration : IEntityTypeConfiguration<WikiDocumentChunkContentEntity>
{
    /// <inheritdoc/>
    public void Configure(EntityTypeBuilder<WikiDocumentChunkContentEntity> builder)
    {
        var entity = builder;
        entity.HasKey(e => e.Id).HasName("idx_wiki_document_chunk_content_primary");

        entity.ToTable("wiki_document_chunk_content", tb => tb.HasComment("文档切片内容"));

        entity.HasIndex(e => new { e.DocumentId, e.Id }, "idx_wiki_document_chunk_content_preview_doc_slice");

        entity.HasIndex(e => e.WikiId, "idx_wiki_document_chunk_content_preview_wiki_slice");
