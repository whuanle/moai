...
internal partial class AppChatappChatHistoryConfiguration : IEntityTypeConfiguration<AppChatappChatHistoryEntity>
{
    ...
    {
        var entity = builder;
        entity.HasKey(e => e.Id).HasName("idx_63091_primary");

        entity.ToTable("app_chatapp_chat_history", tb => tb.HasComment("对话历史，不保存实际历史记录"));

        entity.HasIndex(e => e.ChatId, "idx_63091_chat_history_pk_2");
    ...
    partial void OnConfigurePartial(EntityTypeBuilder<AppChatappChatHistoryEntity> modelBuilder);
}
