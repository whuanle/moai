...
/// 切片衍生内容表（提问/提纲/摘要）.
/// </summary>
public partial class WikiDocumentChunkDerivativeConfiguration : IEntityTypeConfiguration<WikiDocumentChunkDerivativeEntity>
{
    /// <inheritdoc/>
    public void Configure(EntityTypeBuilder<WikiDocumentChunkDerivativeEntity> builder)
    {
        var entity = builder;
        entity.HasKey(e => e.Id).HasName("PRIMARY");

        entity.ToTable("wiki_document_chunk_derivative", tb => tb.HasComment("切片衍生内容表（提问/提纲/摘要）"));
    ...
    partial void OnConfigurePartial(EntityTypeBuilder<WikiDocumentChunkDerivativeEntity> modelBuilder);
}
