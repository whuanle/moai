...
/// 创建 AI 渠道.
/// </summary>
public class CreateAIChannelCommand : IRequest<EmptyCommandResponse>, IModelValidator<CreateAIChannelCommand>
{
    /// <summary>
    ...
    /// <inheritdoc/>
    public static void Validate(AbstractValidator<CreateAIChannelCommand> validate)
    {
