...
public class PublicController : ControllerBase
{
    ...
    public async Task<PreUploadFileCommandResponse> PreUpload([FromBody] PreUploadImageCommand req, CancellationToken ct = default)
    {
    ...
    public async Task<PreUploadFileCommandResponse> PreUploadTemp([FromBody] PreUploadTempFileCommand req, CancellationToken ct = default)
    {
        return await _mediator.Send(req, ct);
    }
}
