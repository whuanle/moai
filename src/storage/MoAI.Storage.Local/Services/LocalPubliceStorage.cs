// <copyright file="LocalPubliceStorage.cs" company="MoAI">
...
public class LocalPubliceStorage : IPublicFileStorage
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LocalPubliceStorage"/> class.
    /// </summary>
