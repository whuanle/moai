...
/// </summary>
public class StartWikiCrawlerPluginTaskCommandHandler : IRequestHandler<StartWikiCrawlerPluginTaskCommand, SimpleGuid>
{
    ...
    /// <inheritdoc/>
    public async Task<SimpleGuid> Handle(StartWikiCrawlerPluginTaskCommand request, CancellationToken cancellationToken)
    {
