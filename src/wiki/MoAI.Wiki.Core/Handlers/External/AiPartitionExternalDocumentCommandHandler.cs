...
/// <summary>
/// <inheritdoc cref="AiPartitionExternalDocumentCommand"/>
/// </summary>
public class AiPartitionExternalDocumentCommandHandler : IRequestHandler<AiPartitionExternalDocumentCommand, EmptyCommandResponse>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AiPartitionExternalDocumentCommandHandler"/> class.
    /// </summary>
    /// <param name="databaseContext">数据库上下文.</param>
    /// <param name="externalWikiAuthorizer">外部知识库授权器.</param>
    /// <param name="processingService">文档内容处理服务.</param>
    public AiPartitionExternalDocumentCommandHandler(
    ...
    /// <inheritdoc/>
    public async Task<EmptyCommandResponse> Handle(AiPartitionExternalDocumentCommand request, CancellationToken cancellationToken)
    {
