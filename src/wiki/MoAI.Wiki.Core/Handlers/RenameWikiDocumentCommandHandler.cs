...
/// <summary>
/// <inheritdoc cref="RenameWikiDocumentCommand"/>
/// </summary>
public class RenameWikiDocumentCommandHandler : IRequestHandler<RenameWikiDocumentCommand, EmptyCommandResponse>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RenameWikiDocumentCommandHandler"/> class.
    /// </summary>
    /// <param name="databaseContext">数据库上下文.</param>
    /// <param name="teamService">团队领域服务.</param>
    /// <param name="userContextProvider">用户上下文提供者.</param>
    public RenameWikiDocumentCommandHandler(DatabaseContext databaseContext, ITeamService teamService, IUserContextProvider userContextProvider)
    {
    ...
    /// <inheritdoc/>
    public async Task<EmptyCommandResponse> Handle(RenameWikiDocumentCommand request, CancellationToken cancellationToken)
    {
