...
/// <summary>
/// <inheritdoc cref="EmbeddingDocumentCommand"/>
/// </summary>
public class EmbeddingDocumentCommandHandler : IRequestHandler<EmbeddingDocumentCommand, EmbeddingDocumentCommandResponse>
{
    ...
    public EmbeddingDocumentCommandHandler(DatabaseContext databaseContext, ITeamService teamService, IUserContextProvider userContextProvider, IMessagePublisher messagePublisher)
    {
    ...
    /// <inheritdoc/>
    public async Task<EmbeddingDocumentCommandResponse> Handle(EmbeddingDocumentCommand request, CancellationToken cancellationToken)
    {
