...
/// <summary>
/// <inheritdoc cref="PartitionDocumentCommand"/>
/// </summary>
public class PartitionDocumentCommandHandler : IRequestHandler<PartitionDocumentCommand, EmptyCommandResponse>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="PartitionDocumentCommandHandler"/> class.
    /// </summary>
    /// <param name="databaseContext">数据库上下文.</param>
    /// <param name="teamService">团队领域服务.</param>
    /// <param name="userContextProvider">用户上下文提供者.</param>
    /// <param name="processingService">文档内容处理服务.</param>
    public PartitionDocumentCommandHandler(
    ...
    /// <inheritdoc/>
    public async Task<EmptyCommandResponse> Handle(PartitionDocumentCommand request, CancellationToken cancellationToken)
    {
