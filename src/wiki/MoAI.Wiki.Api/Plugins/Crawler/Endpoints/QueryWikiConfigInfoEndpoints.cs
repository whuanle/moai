...
public class QueryWikiConfigInfoEndpoints : Endpoint<QueryWikiCrawlerConfigICommand, QueryWikiCrawlerConfigCommandResponse>
{
    ...
    /// <inheritdoc/>
    public override async Task<QueryWikiCrawlerConfigCommandResponse> ExecuteAsync(QueryWikiCrawlerConfigICommand req, CancellationToken ct)
    {
