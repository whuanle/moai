...
/// 添加一个网页爬取配置.
/// </summary>
public class AddWikiCrawlerConfigCommand : AddWikiPluginConfigCommand<WikiCrawlerConfig>, IRequest<SimpleInt>, IModelValidator<AddWikiCrawlerConfigCommand>
{
    /// <inheritdoc/>
    public void Validate(AbstractValidator<AddWikiCrawlerConfigCommand> validate)
    {
        ...
        validate.RuleFor(x => x.Config.LimitAddress)
            .Must((a, b) =>
            {
