...
public class QueryWikiDocumentTextPartitionCommandResponse
{
    /// <summary>
    ...
    /// 分块的内容.
    /// </summary>
    public IReadOnlyCollection<WikiDocumentTextPartitionPreviewItem> Items { get; init; } = Array.Empty<WikiDocumentTextPartitionPreviewItem>();
}