...
/// </summary>
public class UpdateTeamOpenApiPluginCommand : IRequest<EmptyCommandResponse>, IModelValidator<UpdateTeamOpenApiPluginCommand>
{
    /// <summary>
    /// 团队 id.
    /// </summary>
    ...
    /// <inheritdoc/>
    public static void Validate(AbstractValidator<UpdateTeamOpenApiPluginCommand> validate)
    {
