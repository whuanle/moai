...
public class QueryInternalPluginDetailEndpoint : Endpoint<QueryInternalPluginDetailCommand, QueryInternalPluginDetailCommandResponse>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="QueryInternalPluginDetailEndpoint"/> class.
    /// </summary>
    /// <param name="mediator"></param>
    /// <param name="userContext"></param>
    public QueryInternalPluginDetailEndpoint(IMediator mediator, UserContext userContext)
    {
        _mediator = mediator;
