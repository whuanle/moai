...
/// <summary>
/// <inheritdoc cref="QueryTeamAvailablePluginListCommand"/>
/// </summary>
public class QueryTeamAvailablePluginListCommandHandler : IRequestHandler<QueryTeamAvailablePluginListCommand, QueryTeamAvailablePluginListCommandResponse>
{
    private readonly DatabaseContext _databaseContext;
    private readonly INativePluginFactory _nativePluginFactory;

    /// <summary>
    /// Initializes a new instance of the <see cref="QueryTeamAvailablePluginListCommandHandler"/> class.
    /// </summary>
    /// <param name="databaseContext"></param>
    /// <param name="nativePluginFactory"></param>
    public QueryTeamAvailablePluginListCommandHandler(DatabaseContext databaseContext, INativePluginFactory nativePluginFactory)
    {
    ...
    /// <inheritdoc/>
    public async Task<QueryTeamAvailablePluginListCommandResponse> Handle(QueryTeamAvailablePluginListCommand request, CancellationToken cancellationToken)
    {
        // 查询公开插件和团队专属插件
        ...
        return new QueryTeamAvailablePluginListCommandResponse
        {
