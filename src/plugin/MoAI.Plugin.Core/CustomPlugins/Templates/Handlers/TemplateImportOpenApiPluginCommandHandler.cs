...
/// </summary>
public class TemplateImportOpenApiPluginCommandHandler : IRequestHandler<TemplateImportOpenApiPluginCommand, SimpleInt>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="TemplateImportOpenApiPluginCommandHandler"/> class.
    /// </summary>
    /// <param name="mediator"></param>
    /// <param name="databaseContext"></param>
    /// <param name="logger"></param>
    public TemplateImportOpenApiPluginCommandHandler(IMediator mediator, DatabaseContext databaseContext, ILogger<ImportOpenApiPluginCommandHandler> logger)
    {
        _mediator = mediator;
    ...
    /// <inheritdoc/>
    public async Task<SimpleInt> Handle(TemplateImportOpenApiPluginCommand request, CancellationToken cancellationToken)
    {
