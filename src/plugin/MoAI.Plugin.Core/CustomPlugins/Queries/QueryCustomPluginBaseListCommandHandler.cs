...
/// <summary>
/// <inheritdoc cref="QueryCustomPluginBaseListCommand"/>
/// </summary>
public class QueryCustomPluginBaseListCommandHandler : IRequestHandler<QueryCustomPluginBaseListCommand, QueryCustomPluginBaseListCommandResponse>
{
    private readonly DatabaseContext _dbContext;
    private readonly IMediator _mediator;

    /// <summary>
    /// Initializes a new instance of the <see cref="QueryCustomPluginBaseListCommandHandler"/> class.
    /// </summary>
    /// <param name="dbContext"></param>
    /// <param name="mediator"></param>
    public QueryCustomPluginBaseListCommandHandler(DatabaseContext dbContext, IMediator mediator)
    {
