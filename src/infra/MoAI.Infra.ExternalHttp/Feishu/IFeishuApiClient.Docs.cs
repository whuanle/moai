...
public partial interface IFeishuApiClient
{
    ...
    Task<GetWikiSpacesResponse> GetWikiSpacesAsync([Query] GetWikiSpacesRequest request);
    ...
    Task<GetWikiSpaceInfoResponse> GetWikiSpaceInfoAsync([AliasAs("space_id")] string spaceId, [Query] string? lang = null);
    ...
    Task<GetWikiNodesResponse> GetWikiNodesAsync([AliasAs("space_id")] string spaceId, [Query] GetWikiNodesRequest request);
    ...
    Task<GetDocumentInfoResponse> GetDocumentInfoAsync([AliasAs("document_id")] string documentId);
    ...
    Task<GetDocumentRawContentResponse> GetDocumentRawContentAsync([AliasAs("document_id")] string documentId, [Query] int? lang = null);
}