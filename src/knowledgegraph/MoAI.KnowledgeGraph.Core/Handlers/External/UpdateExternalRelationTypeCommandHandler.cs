...
/// <summary>
/// <inheritdoc cref="UpdateExternalRelationTypeCommand"/>
/// </summary>
public class UpdateExternalRelationTypeCommandHandler : IRequestHandler<UpdateExternalRelationTypeCommand, EmptyCommandResponse>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="UpdateExternalRelationTypeCommandHandler"/> class.
    /// </summary>
    /// <param name="databaseContext">数据库上下文.</param>
    /// <param name="externalAuthorizer">外部授权器.</param>
    /// <param name="settingsService">知识图谱设置.</param>
    public UpdateExternalRelationTypeCommandHandler(DatabaseContext databaseContext, IExternalKnowledgeGraphAuthorizer externalAuthorizer, IKnowledgeGraphSettingsService settingsService)
    {
    ...
    /// <inheritdoc/>
    public async Task<EmptyCommandResponse> Handle(UpdateExternalRelationTypeCommand request, CancellationToken cancellationToken)
    {
