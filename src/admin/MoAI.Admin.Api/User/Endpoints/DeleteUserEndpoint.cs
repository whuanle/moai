// <copyright file="DeleteUserEndpoint.cs" company="MoAI">
...
/// 删除用户.
/// </summary>
[HttpPost($"{ApiPrefix.User}/delete_user")]
public class DeleteUserEndpoint : Endpoint<DeleteUserCommand, EmptyCommandResponse>
{
    private readonly IMediator _mediator;
    private readonly UserContext _userContext;

    /// <summary>
    /// Initializes a new instance of the <see cref="DeleteUserEndpoint"/> class.
    /// </summary>
    /// <param name="mediator"></param>
    /// <param name="userContext"></param>
    public DeleteUserEndpoint(IMediator mediator, UserContext userContext)
    {
        _mediator = mediator;
