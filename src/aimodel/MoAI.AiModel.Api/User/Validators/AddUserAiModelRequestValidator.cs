// <copyright file="AddUserAiModelRequestValidator.cs" company="MoAI">
...
/// </summary>
public class AddUserAiModelRequestValidator : Validator<AddUserAiModelRequest>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AddUserAiModelRequestValidator"/> class.
    /// </summary>
    public AddUserAiModelRequestValidator()
    {
        RuleFor(x => x.Title)
