...
/// <summary>
/// AddSystemAiModelRequestValidator.
/// </summary>
public class AddSystemAiModelRequestValidator : Validator<AddSystemAiModelRequest>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="AddSystemAiModelRequestValidator"/> class.
    /// </summary>
    public AddSystemAiModelRequestValidator()
    {
        RuleFor(x => x.Title)
