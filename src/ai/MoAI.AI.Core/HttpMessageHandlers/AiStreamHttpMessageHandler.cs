...
/// </summary>
[InjectOnTransient]
public class AiStreamHttpMessageHandler : DelegatingHandler
{
    private readonly ILogger<AiStreamHttpMessageHandler> _logger;
    private readonly SystemOptions _systemOptions;

    /// <summary>
    /// Initializes a new instance of the <see cref="AiStreamHttpMessageHandler"/> class.
    /// </summary>
    /// <param name="logger"></param>
    /// <param name="systemOptions"></param>
    public AiStreamHttpMessageHandler(ILogger<AiStreamHttpMessageHandler> logger, SystemOptions systemOptions)
    {
        _logger = logger;
