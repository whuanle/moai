...
/// </summary>
public class QueryChatAppInstanceTopicListCommandHandler : IRequestHandler<QueryChatApptInstanceTopicListCommand, QueryChatAppInstanceTopicListCommandResponse>
{
    private readonly DatabaseContext _databaseContext;

    /// <summary>
    /// Initializes a new instance of the <see cref="QueryChatAppInstanceTopicListCommandHandler"/> class.
    /// </summary>
    /// <param name="databaseContext"></param>
    public QueryChatAppInstanceTopicListCommandHandler(DatabaseContext databaseContext)
    {
