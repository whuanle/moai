...
/// 创建系统接入.
/// </summary>
public class CreateExternalAppCommand : IUserIdContext, IRequest<CreateExternalAppCommandResponse>, IModelValidator<CreateExternalAppCommand>
{
    /// <inheritdoc/>
    ...
    /// <inheritdoc/>
    public static void Validate(AbstractValidator<CreateExternalAppCommand> validate)
    {
