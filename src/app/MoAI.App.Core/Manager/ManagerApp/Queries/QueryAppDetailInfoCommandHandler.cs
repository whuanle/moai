...
/// <summary>
/// <inheritdoc cref="QueryAppDetailInfoCommand"/>
/// </summary>
public class QueryAppDetailInfoCommandHandler : IRequestHandler<QueryAppDetailInfoCommand, QueryAppDetailInfoCommandResponse>
{
    private readonly DatabaseContext _databaseContext;
    private readonly IMediator _mediator;

    /// <summary>
    /// Initializes a new instance of the <see cref="QueryAppDetailInfoCommandHandler"/> class.
    /// </summary>
    /// <param name="databaseContext"></param>
    /// <param name="mediator"></param>
    public QueryAppDetailInfoCommandHandler(DatabaseContext databaseContext, IMediator mediator)
    {
    ...
    public async Task<QueryAppDetailInfoCommandResponse> Handle(QueryAppDetailInfoCommand request, CancellationToken cancellationToken)
    {
        ...
        var response = new QueryAppDetailInfoCommandResponse
        {
            AppId = result.App.Id,
