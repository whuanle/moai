...
// @ts-ignore
import { AiapiRequestBuilderNavigationMetadata, type AiapiRequestBuilder } from './aiapi/index.js';
// @ts-ignore
...
/**
 * Instantiates a new {@link MoAIClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createMoAIClient(requestAdapter: RequestAdapter) {
    ...
    if (requestAdapter.baseUrl === undefined || requestAdapter.baseUrl === null || requestAdapter.baseUrl === "") {
        requestAdapter.baseUrl = "http://127.0.0.1:5100";
    }
    const pathParameters: Record<string, unknown> = {
        "baseurl": requestAdapter.baseUrl,
    };
    return apiClientProxifier<MoAIClient>(requestAdapter, pathParameters, MoAIClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface MoAIClient extends BaseRequestBuilder<MoAIClient> {
    /**
     * The aiapi property
     */
    get aiapi(): AiapiRequestBuilder;
    /**
     * The api property
     */
 ...
 */
export const MoAIClientUriTemplate = "{+baseurl}";
/**
...
export const MoAIClientNavigationMetadata: Record<Exclude<keyof MoAIClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    aiapi: {
        navigationMetadata: AiapiRequestBuilderNavigationMetadata,
    },
    api: {
