...
/**
 * Builds and executes requests for operations under /api/auth/oauth_prividers
 */
 ...
 */
export const Oauth_prividersRequestBuilderUriTemplate = "{+baseurl}/api/auth/oauth_prividers";
/**
