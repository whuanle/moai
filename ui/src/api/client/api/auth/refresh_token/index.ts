...
/**
 * Builds and executes requests for operations under /api/auth/refresh_token
 */
 ...
 */
export const Refresh_tokenRequestBuilderUriTemplate = "{+baseurl}/api/auth/refresh_token";
/**
