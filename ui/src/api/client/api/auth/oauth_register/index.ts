...
/**
 * Builds and executes requests for operations under /api/auth/oauth_register
 */
 ...
 */
export const Oauth_registerRequestBuilderUriTemplate = "{+baseurl}/api/auth/oauth_register";
/**
