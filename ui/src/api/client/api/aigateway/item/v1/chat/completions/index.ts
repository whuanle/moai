...
/**
 * Builds and executes requests for operations under /api/aigateway/{teamId}/v1/chat/completions
 */
 ...
 */
export const CompletionsRequestBuilderUriTemplate = "{+baseurl}/api/aigateway/{teamId}/v1/chat/completions";
/**
