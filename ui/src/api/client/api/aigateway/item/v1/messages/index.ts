...
/**
 * Builds and executes requests for operations under /api/aigateway/{teamId}/v1/messages
 */
 ...
 */
export const MessagesRequestBuilderUriTemplate = "{+baseurl}/api/aigateway/{teamId}/v1/messages";
/**
