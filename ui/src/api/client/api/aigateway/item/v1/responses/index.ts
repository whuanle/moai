...
/**
 * Builds and executes requests for operations under /api/aigateway/{teamId}/v1/responses
 */
 ...
 */
export const ResponsesRequestBuilderUriTemplate = "{+baseurl}/api/aigateway/{teamId}/v1/responses";
/**
