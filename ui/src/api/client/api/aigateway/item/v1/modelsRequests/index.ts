...
/**
 * Builds and executes requests for operations under /api/aigateway/{teamId}/v1/models
 */
 ...
 */
export const ModelsRequestBuilderUriTemplate = "{+baseurl}/api/aigateway/{teamId}/v1/models";
/**
