...
/**
 * Builds and executes requests for operations under /api/wiki/{-id}/documents/{documentId}/extract
 */
 ...
 */
export const ExtractRequestBuilderUriTemplate = "{+baseurl}/api/wiki/{%2Did}/documents/{documentId}/extract";
/**
