...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createQueryExternalAuthorizedAppsCommandResponseFromDiscriminatorValue, type BusinessValidationResult, type QueryExternalAuthorizedAppsCommandResponse } from '../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/external/app/list
 */
export interface ListRequestBuilder extends BaseRequestBuilder<ListRequestBuilder> {
     ...
     * @returns {Promise<QueryExternalAuthorizedAppsCommandResponse>}
     ...
     */
     get(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<QueryExternalAuthorizedAppsCommandResponse | undefined>;
    /**
     * 查询当前外部 token 授权范围内的应用列表（已发布且未禁用），需要外部 token.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const ListRequestBuilderUriTemplate = "{+baseurl}/api/external/app/list";
/**
...
export const ListRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createQueryExternalAuthorizedAppsCommandResponseFromDiscriminatorValue,
    },
};
/* tslint:enable */
/* eslint-enable */
