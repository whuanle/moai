...
/**
 * Builds and executes requests for operations under /api/external/wiki/{wikiId}/documents/{documentId}/extract
 */
 ...
 */
export const ExtractRequestBuilderUriTemplate = "{+baseurl}/api/external/wiki/{wikiId}/documents/{documentId}/extract";
/**
