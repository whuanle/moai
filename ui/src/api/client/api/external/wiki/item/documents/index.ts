...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, serializeDeleteExternalWikiDocumentsCommand, serializeEmptyCommandResponse, type BusinessValidationResult, type DeleteExternalWikiDocumentsCommand, type EmptyCommandResponse } from '../../../../../models/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /api/external/wiki/{wikiId}/documents
 */
export interface DocumentsRequestBuilder extends BaseRequestBuilder<DocumentsRequestBuilder> {
    ...
    /**
     * Gets an item from the ApiSdk.api.external.wiki.item.documents.item collection
     ...
     */
     delete(body: DeleteExternalWikiDocumentsCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EmptyCommandResponse | undefined>;
    /**
     * 批量删除文档（连带切片/元数据/存储文件）（外部语义：团队级授权）.
     * @param body 删除知识库文档（外部接口）.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toDeleteRequestInformation(body: DeleteExternalWikiDocumentsCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const DocumentsRequestBuilderUriTemplate = "{+baseurl}/api/external/wiki/{wikiId}/documents";
/**
...
export const DocumentsRequestBuilderRequestsMetadata: RequestsMetadata = {
    delete: {
        ...
        requestBodySerializer: serializeDeleteExternalWikiDocumentsCommand,
