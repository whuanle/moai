...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createQueryExternalGraphsResponseFromDiscriminatorValue, type BusinessValidationResult, type QueryExternalGraphsResponse } from '../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/external/knowledge-graph/list
 */
export interface ListRequestBuilder extends BaseRequestBuilder<ListRequestBuilder> {
     ...
     * @returns {Promise<QueryExternalGraphsResponse>}
     ...
     */
     post(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<QueryExternalGraphsResponse | undefined>;
    /**
     * 查询 token 归属团队下的知识图谱列表（外部语义：团队级授权，仅返回托管图）.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const ListRequestBuilderUriTemplate = "{+baseurl}/api/external/knowledge-graph/list";
/**
...
export const ListRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        responseBodyFactory:  createQueryExternalGraphsResponseFromDiscriminatorValue,
    },
};
/* tslint:enable */
/* eslint-enable */
