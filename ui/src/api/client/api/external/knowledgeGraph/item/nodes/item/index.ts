...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, createQueryKnowledgeGraphNodeCommandResponseFromDiscriminatorValue, serializeEmptyCommandResponse, serializeUpdateExternalNodeCommand, type BusinessValidationResult, type EmptyCommandResponse, type QueryKnowledgeGraphNodeCommandResponse, type UpdateExternalNodeCommand } from '../../../../../../models/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /api/external/knowledge-graph/{kgId}/nodes/{nodeId}
 */
export interface WithNodeItemRequestBuilder extends BaseRequestBuilder<WithNodeItemRequestBuilder> {
     ...
     * @throws {BusinessValidationResult} error when the service returns a 500 status code
     */
     put(body: UpdateExternalNodeCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EmptyCommandResponse | undefined>;
    /**
     * 删除节点（连带其边）（外部语义：团队级授权）.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     * @returns {RequestInformation}
     */
     toPutRequestInformation(body: UpdateExternalNodeCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const WithNodeItemRequestBuilderUriTemplate = "{+baseurl}/api/external/knowledge-graph/{kgId}/nodes/{nodeId}";
/**
...
export const WithNodeItemRequestBuilderRequestsMetadata: RequestsMetadata = {
    ...
    put: {
        ...
        requestBodySerializer: serializeUpdateExternalNodeCommand,
