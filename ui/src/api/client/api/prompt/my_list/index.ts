...
/**
 * Builds and executes requests for operations under /api/prompt/my_list
 */
export interface My_listRequestBuilder extends BaseRequestBuilder<My_listRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<My_listRequestBuilderGetQueryParameters> | undefined) : Promise<QueryPromptListCommandResponse | undefined>;
    /**
     * 查询我的个人提示词列表.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const My_listRequestBuilderUriTemplate = "{+baseurl}/api/prompt/my_list{?ContextUserId*,ContextUserType*,Keywords*,PromptClassId*}";
/**
