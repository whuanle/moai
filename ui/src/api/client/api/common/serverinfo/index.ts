...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createQueryServerInfoCommandResponseFromDiscriminatorValue, type BusinessValidationResult, type QueryServerInfoCommandResponse } from '../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/common/serverinfo
 */
export interface ServerinfoRequestBuilder extends BaseRequestBuilder<ServerinfoRequestBuilder> {
    /**
     * 获取服务器信息.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<QueryServerInfoCommandResponse>}
     ...
     */
     get(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<QueryServerInfoCommandResponse | undefined>;
    /**
     * 获取服务器信息.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const ServerinfoRequestBuilderUriTemplate = "{+baseurl}/api/common/serverinfo";
/**
...
export const ServerinfoRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createQueryServerInfoCommandResponseFromDiscriminatorValue,
    },
};
/* tslint:enable */
/* eslint-enable */
