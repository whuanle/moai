...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, serializeEmptyCommandResponse, serializeUpdatePluginAvatarCommand, type BusinessValidationResult, type EmptyCommandResponse, type UpdatePluginAvatarCommand } from '../../../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/ai/plugin/manage/{id}/avatar
 */
export interface AvatarRequestBuilder extends BaseRequestBuilder<AvatarRequestBuilder> {
    /**
     * 设置插件头像.
     * @param body 设置插件头像；仅管理员可操作；objectKey 需为已完成上传并登记的文件.
     ...
     */
     post(body: UpdatePluginAvatarCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EmptyCommandResponse | undefined>;
    /**
     * 设置插件头像.
     * @param body 设置插件头像；仅管理员可操作；objectKey 需为已完成上传并登记的文件.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: UpdatePluginAvatarCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const AvatarRequestBuilderUriTemplate = "{+baseurl}/api/ai/plugin/manage/{id}/avatar";
/**
...
export const AvatarRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        requestBodySerializer: serializeUpdatePluginAvatarCommand,
