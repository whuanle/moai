...
/**
 * Builds and executes requests for operations under /api/team/{-id}/plugin/{pluginId}/refresh_mcp
 */
 ...
 */
export const Refresh_mcpRequestBuilderUriTemplate = "{+baseurl}/api/team/{%2Did}/plugin/{pluginId}/refresh_mcp";
/**
