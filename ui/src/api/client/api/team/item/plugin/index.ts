...
// @ts-ignore
import { Dynamic_templatesRequestBuilderRequestsMetadata, type Dynamic_templatesRequestBuilder } from './dynamic_templates/index.js';
// @ts-ignore
...
export interface PluginRequestBuilder extends BaseRequestBuilder<PluginRequestBuilder> {
    ...
    /**
     * The dynamic_templates property
     */
    get dynamic_templates(): Dynamic_templatesRequestBuilder;
    /**
     * The list property
     */
...
export const PluginRequestBuilderNavigationMetadata: Record<Exclude<keyof PluginRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    ...
    dynamic_templates: {
        requestsMetadata: Dynamic_templatesRequestBuilderRequestsMetadata,
    },
    list: {
