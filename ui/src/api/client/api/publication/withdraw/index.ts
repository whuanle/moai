...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, serializeEmptyCommandResponse, serializeWithdrawPublicationCommand, type BusinessValidationResult, type EmptyCommandResponse, type WithdrawPublicationCommand } from '../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/publication/withdraw
 */
export interface WithdrawRequestBuilder extends BaseRequestBuilder<WithdrawRequestBuilder> {
     ...
     * @param body 撤回上架申请，仅待审核状态可撤回；需要资源所属团队的 Admin 及以上角色.
     ...
     */
     post(body: WithdrawPublicationCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EmptyCommandResponse | undefined>;
    /**
     * 撤回上架申请，仅待审核状态可撤回；需要资源所属团队 Admin 及以上角色.
     * @param body 撤回上架申请，仅待审核状态可撤回；需要资源所属团队的 Admin 及以上角色.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: WithdrawPublicationCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const WithdrawRequestBuilderUriTemplate = "{+baseurl}/api/publication/withdraw";
/**
...
export const WithdrawRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        requestBodySerializer: serializeWithdrawPublicationCommand,
