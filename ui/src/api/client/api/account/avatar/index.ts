...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, serializeEmptyCommandResponse, serializeUpdateUserAvatarCommand, type BusinessValidationResult, type EmptyCommandResponse, type UpdateUserAvatarCommand } from '../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/account/avatar
 */
export interface AvatarRequestBuilder extends BaseRequestBuilder<AvatarRequestBuilder> {
     ...
     */
     post(body: UpdateUserAvatarCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EmptyCommandResponse | undefined>;
    /**
     * 更新用户头像.
     * @param body 更新用户头像.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: UpdateUserAvatarCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const AvatarRequestBuilderUriTemplate = "{+baseurl}/api/account/avatar";
/**
...
export const AvatarRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        requestBodySerializer: serializeUpdateUserAvatarCommand,
