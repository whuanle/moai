...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createSimpleLongFromDiscriminatorValue, serializeRegisterUserCommand, serializeSimpleLong, type BusinessValidationResult, type RegisterUserCommand, type SimpleLong } from '../../../models/index.js';
// @ts-ignore
...
export interface RegisterRequestBuilder extends BaseRequestBuilder<RegisterRequestBuilder> {
     ...
     */
     post(body: RegisterUserCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<SimpleLong | undefined>;
    /**
     * 注册账号.
     * @param body 注册用户.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
