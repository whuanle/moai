...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, serializeEmptyCommandResponse, serializeOAuthLoginCommand, type BusinessValidationResult, type EmptyCommandResponse, type OAuthLoginCommand } from '../../../models/index.js';
// @ts-ignore
...
export interface Oauth_bindRequestBuilder extends BaseRequestBuilder<Oauth_bindRequestBuilder> {
     ...
     * @param body 当前登录账号通过第三方授权回调 code 绑定第三方账号.
     ...
     */
     post(body: OAuthLoginCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EmptyCommandResponse | undefined>;
    /**
     * 当前登录账号通过第三方授权回调 code 绑定第三方账号（与登录接口分离，需登录态）.
     * @param body 当前登录账号通过第三方授权回调 code 绑定第三方账号.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
