...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, serializeEmptyCommandResponse, serializeUpdateKnowledgeGraphAvatarCommand, type BusinessValidationResult, type EmptyCommandResponse, type UpdateKnowledgeGraphAvatarCommand } from '../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/knowledge-graph/{id}/avatar
 */
export interface AvatarRequestBuilder extends BaseRequestBuilder<AvatarRequestBuilder> {
    /**
     * 设置图谱头像，仅 Owner/Admin 可操作.
     * @param body 设置知识图谱头像，仅 Owner/Admin 可操作；objectKey 需为已完成上传并登记的文件.
     ...
     */
     post(body: UpdateKnowledgeGraphAvatarCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EmptyCommandResponse | undefined>;
    /**
     * 设置图谱头像，仅 Owner/Admin 可操作.
     * @param body 设置知识图谱头像，仅 Owner/Admin 可操作；objectKey 需为已完成上传并登记的文件.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: UpdateKnowledgeGraphAvatarCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const AvatarRequestBuilderUriTemplate = "{+baseurl}/api/knowledge-graph/{id}/avatar";
/**
...
export const AvatarRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        requestBodySerializer: serializeUpdateKnowledgeGraphAvatarCommand,
