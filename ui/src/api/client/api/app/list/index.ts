...
/**
 * Builds and executes requests for operations under /api/app/list
 */
 ...
 */
export const ListRequestBuilderUriTemplate = "{+baseurl}/api/app/list{?ContextUserId*,ContextUserType*,TeamId*}";
/**
