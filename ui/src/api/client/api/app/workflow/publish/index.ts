...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, serializeEmptyCommandResponse, serializePublishAppWorkflowCommand, type BusinessValidationResult, type EmptyCommandResponse, type PublishAppWorkflowCommand } from '../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/app/workflow/publish
 */
export interface PublishRequestBuilder extends BaseRequestBuilder<PublishRequestBuilder> {
     ...
     * @param body 发布流程应用编排：校验草稿定义合法后生成不可变的已发布快照（版本号递增），并置应用为已发布.需要团队 Admin 及以上角色.
     ...
     */
     post(body: PublishAppWorkflowCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EmptyCommandResponse | undefined>;
    /**
     * 发布流程应用编排：校验草稿合法后生成不可变已发布快照（版本递增），并置应用为已发布；需要团队 Admin 及以上角色.
     * @param body 发布流程应用编排：校验草稿定义合法后生成不可变的已发布快照（版本号递增），并置应用为已发布.需要团队 Admin 及以上角色.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: PublishAppWorkflowCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const PublishRequestBuilderUriTemplate = "{+baseurl}/api/app/workflow/publish";
/**
...
export const PublishRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        requestBodySerializer: serializePublishAppWorkflowCommand,
