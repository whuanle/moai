...
/**
 * Builds and executes requests for operations under /api/app/{id}/logs/{sessionId}
 */
 ...
 */
export const WithSessionItemRequestBuilderUriTemplate = "{+baseurl}/api/app/{id}/logs/{sessionId}";
/**
