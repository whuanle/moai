...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createQueryAppLogMessagesCommandResponseFromDiscriminatorValue, type BusinessValidationResult, type QueryAppLogMessagesCommandResponse } from '../../../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/app/{id}/logs/{sessionId}/messages
 */
export interface MessagesRequestBuilder extends BaseRequestBuilder<MessagesRequestBuilder> {
     ...
     * @returns {Promise<QueryAppLogMessagesCommandResponse>}
     ...
     */
     get(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<QueryAppLogMessagesCommandResponse | undefined>;
    /**
     * 查询指定会话的消息详情（压缩后视图）；需要团队 Admin 及以上角色.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const MessagesRequestBuilderUriTemplate = "{+baseurl}/api/app/{id}/logs/{sessionId}/messages";
/**
...
export const MessagesRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createQueryAppLogMessagesCommandResponseFromDiscriminatorValue,
    },
};
/* tslint:enable */
/* eslint-enable */
