...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createQueryAppsCommandResponseFromDiscriminatorValue, type BusinessValidationResult, type QueryAppsCommandResponse, UserType } from '../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/app/external/list
 */
 ...
 */
export const ListRequestBuilderUriTemplate = "{+baseurl}/api/app/external/list{?ContextUserId*,ContextUserType*,TeamId*}";
/**
...
export const ListRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createQueryAppsCommandResponseFromDiscriminatorValue,
