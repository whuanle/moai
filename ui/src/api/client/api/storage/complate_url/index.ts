...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, serializeCompleteFileUploadCommand, serializeEmptyCommandResponse, type BusinessValidationResult, type CompleteFileUploadCommand, type EmptyCommandResponse } from '../../../models/index.js';
// @ts-ignore
...
export interface Complate_urlRequestBuilder extends BaseRequestBuilder<Complate_urlRequestBuilder> {
     ...
     */
     post(body: CompleteFileUploadCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EmptyCommandResponse | undefined>;
    /**
     * 完成上传回调.
     * @param body 完成文件上传.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
