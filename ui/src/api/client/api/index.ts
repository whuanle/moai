...
// @ts-ignore
import { AccessAppRequestBuilderNavigationMetadata, AccessAppRequestBuilderRequestsMetadata, type AccessAppRequestBuilder } from './accessApp/index.js';
// @ts-ignore
...
export interface ApiRequestBuilder extends BaseRequestBuilder<ApiRequestBuilder> {
    /**
     * The accessApp property
     */
    get accessApp(): AccessAppRequestBuilder;
    /**
...
export const ApiRequestBuilderNavigationMetadata: Record<Exclude<keyof ApiRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    accessApp: {
        requestsMetadata: AccessAppRequestBuilderRequestsMetadata,
        navigationMetadata: AccessAppRequestBuilderNavigationMetadata,
    },
    account: {
