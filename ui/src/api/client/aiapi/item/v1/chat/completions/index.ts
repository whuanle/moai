...
/**
 * Builds and executes requests for operations under /aiapi/{teamId}/v1/chat/completions
 */
 ...
 */
export const CompletionsRequestBuilderUriTemplate = "{+baseurl}/aiapi/{teamId}/v1/chat/completions";
/**
