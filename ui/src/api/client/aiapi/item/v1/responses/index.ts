...
/**
 * Builds and executes requests for operations under /aiapi/{teamId}/v1/responses
 */
 ...
 */
export const ResponsesRequestBuilderUriTemplate = "{+baseurl}/aiapi/{teamId}/v1/responses";
/**
