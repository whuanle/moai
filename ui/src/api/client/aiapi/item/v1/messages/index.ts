...
/**
 * Builds and executes requests for operations under /aiapi/{teamId}/v1/messages
 */
 ...
 */
export const MessagesRequestBuilderUriTemplate = "{+baseurl}/aiapi/{teamId}/v1/messages";
/**
