...
/**
 * Builds and executes requests for operations under /api/ai/plugin/custom/refresh_mcp
 */
 ...
 */
export const Refresh_mcpRequestBuilderUriTemplate = "{+baseurl}/api/ai/plugin/custom/refresh_mcp";
/**
