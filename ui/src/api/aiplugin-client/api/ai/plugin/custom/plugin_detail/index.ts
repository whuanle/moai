...
/**
 * Builds and executes requests for operations under /api/ai/plugin/custom/plugin_detail
 */
 ...
 */
export const Plugin_detailRequestBuilderUriTemplate = "{+baseurl}/api/ai/plugin/custom/plugin_detail";
/**
