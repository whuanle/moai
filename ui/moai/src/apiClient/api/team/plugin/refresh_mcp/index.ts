...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, serializeEmptyCommandResponse, serializeRefreshTeamMcpServerPluginCommand, type BusinessValidationResult, type EmptyCommandResponse, type RefreshTeamMcpServerPluginCommand } from '../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/team/plugin/refresh_mcp
 */
export interface Refresh_mcpRequestBuilder extends BaseRequestBuilder<Refresh_mcpRequestBuilder> {
    /**
     * 刷新 mcp 服务器的 tool 列表.
     * @param body 刷新 MCP 服务器的工具列表，也就是重新从 mcp 服务器拉取这个服务的 tool 列表.
     ...
     */
     post(body: RefreshTeamMcpServerPluginCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EmptyCommandResponse | undefined>;
    /**
     * 刷新 mcp 服务器的 tool 列表.
     * @param body 刷新 MCP 服务器的工具列表，也就是重新从 mcp 服务器拉取这个服务的 tool 列表.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: RefreshTeamMcpServerPluginCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const Refresh_mcpRequestBuilderUriTemplate = "{+baseurl}/api/team/plugin/refresh_mcp";
/**
...
export const Refresh_mcpRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        requestBodySerializer: serializeRefreshTeamMcpServerPluginCommand,
