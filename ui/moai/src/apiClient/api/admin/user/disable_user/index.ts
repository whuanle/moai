...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, serializeDisableUserCommand, serializeEmptyCommandResponse, type BusinessValidationResult, type DisableUserCommand, type EmptyCommandResponse } from '../../../../models/index.js';
// @ts-ignore
...
export interface Disable_userRequestBuilder extends BaseRequestBuilder<Disable_userRequestBuilder> {
     ...
     */
     toPostRequestInformation(body: DisableUserCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
...
export const Disable_userRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        requestBodySerializer: serializeDisableUserCommand,
