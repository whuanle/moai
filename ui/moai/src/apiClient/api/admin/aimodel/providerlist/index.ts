...
/**
 * Builds and executes requests for operations under /api/admin/aimodel/providerlist
 */
 ...
 */
export const ProviderlistRequestBuilderUriTemplate = "{+baseurl}/api/admin/aimodel/providerlist";
/**
