...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createSimpleIntFromDiscriminatorValue, type BusinessValidationResult, type SimpleInt } from '../../../../models/index.js';
// @ts-ignore
...
export interface Create_classRequestBuilder extends BaseRequestBuilder<Create_classRequestBuilder> {
     ...
     */
     post(requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<SimpleInt | undefined>;
    /**
     * 创建提示词分类.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
