...
/**
 * Builds and executes requests for operations under /api/admin/plugin/function_list
 */
 ...
 */
export const Function_listRequestBuilderUriTemplate = "{+baseurl}/api/admin/plugin/function_list";
/**
