...
/**
 * Builds and executes requests for operations under /api/admin/plugin/delete_plugin
 */
 ...
 */
export const Delete_pluginRequestBuilderUriTemplate = "{+baseurl}/api/admin/plugin/delete_plugin";
/**
