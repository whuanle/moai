...
/**
 * Builds and executes requests for operations under /api/admin/plugin/refresh_mcp
 */
 ...
 */
export const Refresh_mcpRequestBuilderUriTemplate = "{+baseurl}/api/admin/plugin/refresh_mcp";
/**
