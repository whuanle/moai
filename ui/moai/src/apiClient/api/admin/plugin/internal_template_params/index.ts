...
/**
 * Builds and executes requests for operations under /api/admin/plugin/internal_template_params
 */
 ...
 */
export const Internal_template_paramsRequestBuilderUriTemplate = "{+baseurl}/api/admin/plugin/internal_template_params";
/**
