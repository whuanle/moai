...
/**
 * Builds and executes requests for operations under /api/admin/native_plugin/list
 */
 ...
 */
export const ListRequestBuilderUriTemplate = "{+baseurl}/api/admin/native_plugin/list";
/**
