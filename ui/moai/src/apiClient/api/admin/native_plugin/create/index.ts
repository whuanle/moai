...
/**
 * Builds and executes requests for operations under /api/admin/native_plugin/create
 */
 ...
 */
export const CreateRequestBuilderUriTemplate = "{+baseurl}/api/admin/native_plugin/create";
/**
