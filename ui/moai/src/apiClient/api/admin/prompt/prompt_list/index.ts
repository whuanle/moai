...
/**
 * Builds and executes requests for operations under /api/admin/prompt/prompt_list
 */
 ...
 */
export const Prompt_listRequestBuilderUriTemplate = "{+baseurl}/api/admin/prompt/prompt_list";
/**
