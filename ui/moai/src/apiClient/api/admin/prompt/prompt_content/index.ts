...
/**
 * Builds and executes requests for operations under /api/admin/prompt/prompt_content
 */
 ...
 */
export const Prompt_contentRequestBuilderUriTemplate = "{+baseurl}/api/admin/prompt/prompt_content?PromptId={PromptId}";
/**
