...
/**
 * Builds and executes requests for operations under /api/admin_aimodel/update_aimodel
 */
 ...
 */
export const Update_aimodelRequestBuilderUriTemplate = "{+baseurl}/api/admin_aimodel/update_aimodel";
/**
