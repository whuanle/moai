...
/**
 * Builds and executes requests for operations under /api/admin_aimodel/modellist
 */
 ...
 */
export const ModellistRequestBuilderUriTemplate = "{+baseurl}/api/admin_aimodel/modellist";
/**
