...
/**
 * Builds and executes requests for operations under /api/download/private/{filename}
 */
 ...
 */
export const WithFilenameItemRequestBuilderUriTemplate = "{+baseurl}/api/download/private/{filename}{?expiry*,key*,token*}";
/**
