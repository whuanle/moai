...
/**
 * Builds and executes requests for operations under /api/download/{filename}
 */
 ...
 */
export const WithFilenameItemRequestBuilderUriTemplate = "{+baseurl}/api/download/{filename}{?expiry*,key*,token*}";
/**
