...
/**
 * Builds and executes requests for operations under /api/aimodel/providerlist
 */
 ...
 */
export const ProviderlistRequestBuilderUriTemplate = "{+baseurl}/api/aimodel/providerlist";
/**
