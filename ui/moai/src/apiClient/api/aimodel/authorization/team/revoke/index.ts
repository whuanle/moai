...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, serializeBatchRevokeModelsFromTeamCommand, serializeEmptyCommandResponse, type BatchRevokeModelsFromTeamCommand, type BusinessValidationResult, type EmptyCommandResponse } from '../../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/aimodel/authorization/team/revoke
 */
export interface RevokeRequestBuilder extends BaseRequestBuilder<RevokeRequestBuilder> {
    /**
     * 批量撤销某个团队的模型授权.
     * @param body 批量撤销某个团队的模型授权.
     ...
     */
     post(body: BatchRevokeModelsFromTeamCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EmptyCommandResponse | undefined>;
    /**
     * 批量撤销某个团队的模型授权.
     * @param body 批量撤销某个团队的模型授权.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: BatchRevokeModelsFromTeamCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const RevokeRequestBuilderUriTemplate = "{+baseurl}/api/aimodel/authorization/team/revoke";
/**
...
export const RevokeRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        requestBodySerializer: serializeBatchRevokeModelsFromTeamCommand,
