...
/**
 * Builds and executes requests for operations under /api/admin_plugin/update_internal_plugin
 */
 ...
 */
export const Update_internal_pluginRequestBuilderUriTemplate = "{+baseurl}/api/admin_plugin/update_internal_plugin";
/**
