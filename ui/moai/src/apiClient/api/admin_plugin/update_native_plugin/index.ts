...
/**
 * Builds and executes requests for operations under /api/admin_plugin/update_native_plugin
 */
export interface Update_native_pluginRequestBuilder extends BaseRequestBuilder<Update_native_pluginRequestBuilder> {
    /**
     * 更新内置插件.
     * @param body 修改内置插件实例.
 ...
 */
export const Update_native_pluginRequestBuilderUriTemplate = "{+baseurl}/api/admin_plugin/update_native_plugin";
/**
 * Metadata for all the requests in the request builder.
 */
export const Update_native_pluginRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        uriTemplate: Update_native_pluginRequestBuilderUriTemplate,
