...
/**
 * Builds and executes requests for operations under /api/admin_plugin/delete_plugin
 */
 ...
 */
export const Delete_pluginRequestBuilderUriTemplate = "{+baseurl}/api/admin_plugin/delete_plugin";
/**
