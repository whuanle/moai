...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createRunTestInternalPluginCommandResponseFromDiscriminatorValue, serializeRunTestInternalPluginCommand, serializeRunTestInternalPluginCommandResponse, type BusinessValidationResult, type RunTestInternalPluginCommand, type RunTestInternalPluginCommandResponse } from '../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/admin_plugin/run_internal_plugin
 */
export interface Run_internal_pluginRequestBuilder extends BaseRequestBuilder<Run_internal_pluginRequestBuilder> {
    /**
     * 运行内置插件.
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<RunTestInternalPluginCommandResponse>}
 ...
 */
export const Run_internal_pluginRequestBuilderUriTemplate = "{+baseurl}/api/admin_plugin/run_internal_plugin";
/**
...
export const Run_internal_pluginRequestBuilderRequestsMetadata: RequestsMetadata = {
    delete: {
        ...
        responseBodyFactory:  createRunTestInternalPluginCommandResponseFromDiscriminatorValue,
        requestBodyContentType: "application/json",
        requestBodySerializer: serializeRunTestInternalPluginCommand,
