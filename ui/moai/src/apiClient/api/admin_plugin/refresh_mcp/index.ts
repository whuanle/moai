...
/**
 * Builds and executes requests for operations under /api/admin_plugin/refresh_mcp
 */
 ...
 */
export const Refresh_mcpRequestBuilderUriTemplate = "{+baseurl}/api/admin_plugin/refresh_mcp";
/**
