...
/**
 * Builds and executes requests for operations under /api/admin_plugin/plugin_detail
 */
 ...
 */
export const Plugin_detailRequestBuilderUriTemplate = "{+baseurl}/api/admin_plugin/plugin_detail";
/**
