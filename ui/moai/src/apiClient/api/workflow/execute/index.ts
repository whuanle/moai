...
/**
 * Builds and executes requests for operations under /api/workflow/execute
 */
export interface ExecuteRequestBuilder extends BaseRequestBuilder<ExecuteRequestBuilder> {
    /**
     * 执行工作流.执行指定的工作流定义，通过服务器发送事件（SSE）流式传输实时返回节点执行结果.
 ...
 */
export const ExecuteRequestBuilderUriTemplate = "{+baseurl}/api/workflow/execute";
/**
