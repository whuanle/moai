...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createPromptItemFromDiscriminatorValue, type BusinessValidationResult, type PromptItem, UserType } from '../../../models/index.js';
// @ts-ignore
 ...
 */
export const Prompt_contentRequestBuilderUriTemplate = "{+baseurl}/api/prompt/prompt_content{?ContextUserId*,ContextUserType*,PromptId*}";
/**
