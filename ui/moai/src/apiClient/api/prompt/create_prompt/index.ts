...
/**
 * Builds and executes requests for operations under /api/prompt/create_prompt
 */
 ...
 */
export const Create_promptRequestBuilderUriTemplate = "{+baseurl}/api/prompt/create_prompt";
/**
