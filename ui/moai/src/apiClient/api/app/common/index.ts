...
// @ts-ignore
import { App_listRequestBuilderRequestsMetadata, type App_listRequestBuilder } from './app_list/index.js';
// @ts-ignore
...
export interface CommonRequestBuilder extends BaseRequestBuilder<CommonRequestBuilder> {
    /**
     * The app_list property
     */
    get app_list(): App_listRequestBuilder;
    /**
...
export const CommonRequestBuilderNavigationMetadata: Record<Exclude<keyof CommonRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    app_list: {
        requestsMetadata: App_listRequestBuilderRequestsMetadata,
    },
    chat_history: {
