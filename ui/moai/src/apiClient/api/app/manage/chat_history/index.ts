...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createQueryAppChatHistoryCommandResponseFromDiscriminatorValue, type BusinessValidationResult, type QueryAppChatHistoryCommandResponse, UserType } from '../../../../models/index.js';
// @ts-ignore
...
/**
 * Builds and executes requests for operations under /api/app/manage/chat_history
 */
export interface Chat_historyRequestBuilder extends BaseRequestBuilder<Chat_historyRequestBuilder> {
    /**
     * 获取话题详细内容，即对话历史记录
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<QueryAppChatHistoryCommandResponse>}
     ...
     */
     get(requestConfiguration?: RequestConfiguration<Chat_historyRequestBuilderGetQueryParameters> | undefined) : Promise<QueryAppChatHistoryCommandResponse | undefined>;
    /**
     * 获取话题详细内容，即对话历史记录
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const Chat_historyRequestBuilderUriTemplate = "{+baseurl}/api/app/manage/chat_history{?ChatId*,ContextUserId*,ContextUserType*}";
/**
...
export const Chat_historyRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createQueryAppChatHistoryCommandResponseFromDiscriminatorValue,
