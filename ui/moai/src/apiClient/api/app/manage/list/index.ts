...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createQueryAppListCommandResponseFromDiscriminatorValue, type BusinessValidationResult, type QueryAppListCommandResponse } from '../../../../models/index.js';
// @ts-ignore
 ...
 */
export const ListRequestBuilderUriTemplate = "{+baseurl}/api/app/manage/list{?IsForeign*,TeamId*}";
/**
