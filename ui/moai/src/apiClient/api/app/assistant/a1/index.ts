...
/**
 * Builds and executes requests for operations under /api/app/assistant/a1
 */
export interface A1RequestBuilder extends BaseRequestBuilder<A1RequestBuilder> {
    /**
 ...
 */
export const A1RequestBuilderUriTemplate = "{+baseurl}/api/app/assistant/a1";
/**
 * Metadata for all the requests in the request builder.
 */
export const A1RequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        uriTemplate: A1RequestBuilderUriTemplate,
