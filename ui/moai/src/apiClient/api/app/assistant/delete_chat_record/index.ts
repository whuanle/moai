...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, serializeDeleteAiAssistantChatOneRecordCommand, serializeEmptyCommandResponse, type BusinessValidationResult, type DeleteAiAssistantChatOneRecordCommand, type EmptyCommandResponse } from '../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/app/assistant/delete_chat_record
 */
export interface Delete_chat_recordRequestBuilder extends BaseRequestBuilder<Delete_chat_recordRequestBuilder> {
     ...
     */
     toDeleteRequestInformation(body: DeleteAiAssistantChatOneRecordCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const Delete_chat_recordRequestBuilderUriTemplate = "{+baseurl}/api/app/assistant/delete_chat_record";
/**
 * Metadata for all the requests in the request builder.
 */
export const Delete_chat_recordRequestBuilderRequestsMetadata: RequestsMetadata = {
    delete: {
        uriTemplate: Delete_chat_recordRequestBuilderUriTemplate,
        ...
        requestBodySerializer: serializeDeleteAiAssistantChatOneRecordCommand,
