...
/**
 * Builds and executes requests for operations under /api/plugin/delete_plugin
 */
 ...
 */
export const Delete_pluginRequestBuilderUriTemplate = "{+baseurl}/api/plugin/delete_plugin";
/**
