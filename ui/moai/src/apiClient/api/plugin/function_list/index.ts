...
/**
 * Builds and executes requests for operations under /api/plugin/function_list
 */
 ...
 */
export const Function_listRequestBuilderUriTemplate = "{+baseurl}/api/plugin/function_list";
/**
