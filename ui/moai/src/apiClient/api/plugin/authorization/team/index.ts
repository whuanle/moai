...
/**
 * Builds and executes requests for operations under /api/plugin/authorization/team
 */
 ...
 */
export const TeamRequestBuilderUriTemplate = "{+baseurl}/api/plugin/authorization/team";
/**
