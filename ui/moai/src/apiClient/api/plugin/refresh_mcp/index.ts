...
/**
 * Builds and executes requests for operations under /api/plugin/refresh_mcp
 */
 ...
 */
export const Refresh_mcpRequestBuilderUriTemplate = "{+baseurl}/api/plugin/refresh_mcp";
/**
