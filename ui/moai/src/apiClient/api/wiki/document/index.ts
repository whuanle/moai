...
// @ts-ignore
import { Add_chunk_metadatasRequestBuilderRequestsMetadata, type Add_chunk_metadatasRequestBuilder } from './add_chunk_metadatas/index.js';
// @ts-ignore
...
export interface DocumentRequestBuilder extends BaseRequestBuilder<DocumentRequestBuilder> {
    ...
    /**
     * The add_chunk_metadatas property
     */
    get add_chunk_metadatas(): Add_chunk_metadatasRequestBuilder;
    /**
...
export const DocumentRequestBuilderNavigationMetadata: Record<Exclude<keyof DocumentRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    ...
    add_chunk_metadatas: {
        requestsMetadata: Add_chunk_metadatasRequestBuilderRequestsMetadata,
    },
    ai_generation_chunk: {
