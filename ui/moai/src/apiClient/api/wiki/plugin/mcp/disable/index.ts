...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, serializeDisableWikiMcpCommand, serializeEmptyCommandResponse, type BusinessValidationResult, type DisableWikiMcpCommand, type EmptyCommandResponse } from '../../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/wiki/plugin/mcp/disable
 */
export interface DisableRequestBuilder extends BaseRequestBuilder<DisableRequestBuilder> {
    /**
     * 关闭知识库 MCP 功能.
     * @param body 关闭知识库 MCP 功能.
     ...
     */
     post(body: DisableWikiMcpCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<EmptyCommandResponse | undefined>;
    /**
     * 关闭知识库 MCP 功能.
     * @param body 关闭知识库 MCP 功能.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: DisableWikiMcpCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const DisableRequestBuilderUriTemplate = "{+baseurl}/api/wiki/plugin/mcp/disable";
/**
...
export const DisableRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        requestBodySerializer: serializeDisableWikiMcpCommand,
