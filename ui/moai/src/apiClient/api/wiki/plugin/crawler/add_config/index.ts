...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createSimpleIntFromDiscriminatorValue, serializeAddWikiCrawlerConfigCommand, serializeSimpleInt, type AddWikiCrawlerConfigCommand, type BusinessValidationResult, type SimpleInt } from '../../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/wiki/plugin/crawler/add_config
 */
 ...
 */
export const Add_configRequestBuilderUriTemplate = "{+baseurl}/api/wiki/plugin/crawler/add_config";
/**
