...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createQueryWikiCrawlerConfigCommandResponseFromDiscriminatorValue, type BusinessValidationResult, type QueryWikiCrawlerConfigCommandResponse } from '../../../../../models/index.js';
// @ts-ignore
...
export interface ConfigRequestBuilder extends BaseRequestBuilder<ConfigRequestBuilder> {
     ...
     * @returns {Promise<QueryWikiCrawlerConfigCommandResponse>}
     ...
     */
     get(requestConfiguration?: RequestConfiguration<ConfigRequestBuilderGetQueryParameters> | undefined) : Promise<QueryWikiCrawlerConfigCommandResponse | undefined>;
    /**
     * 获取爬虫配置详细信息.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const ConfigRequestBuilderUriTemplate = "{+baseurl}/api/wiki/plugin/crawler/config{?ConfigId*,WikiId*}";
/**
...
export const ConfigRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createQueryWikiCrawlerConfigCommandResponseFromDiscriminatorValue,
