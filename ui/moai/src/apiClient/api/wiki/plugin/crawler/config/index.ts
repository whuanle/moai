...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createQueryWikiPluginrConfigCommandResponseOfWikiCrawlerConfigFromDiscriminatorValue, type BusinessValidationResult, type QueryWikiPluginrConfigCommandResponseOfWikiCrawlerConfig } from '../../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/wiki/plugin/crawler/config
 */
export interface ConfigRequestBuilder extends BaseRequestBuilder<ConfigRequestBuilder> {
    /**
     * 获取爬虫配置详细信息.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     * @returns {Promise<QueryWikiPluginrConfigCommandResponseOfWikiCrawlerConfig>}
     ...
     */
     get(requestConfiguration?: RequestConfiguration<ConfigRequestBuilderGetQueryParameters> | undefined) : Promise<QueryWikiPluginrConfigCommandResponseOfWikiCrawlerConfig | undefined>;
    /**
     * 获取爬虫配置详细信息.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
 ...
 */
export const ConfigRequestBuilderUriTemplate = "{+baseurl}/api/wiki/plugin/crawler/config?ConfigId={ConfigId}&WikiId={WikiId}";
/**
...
export const ConfigRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createQueryWikiPluginrConfigCommandResponseOfWikiCrawlerConfigFromDiscriminatorValue,
