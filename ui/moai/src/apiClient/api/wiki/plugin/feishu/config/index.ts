...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createQueryWikiFeishuConfigCommandResponseFromDiscriminatorValue, type BusinessValidationResult, type QueryWikiFeishuConfigCommandResponse } from '../../../../../models/index.js';
// @ts-ignore
...
export interface ConfigRequestBuilder extends BaseRequestBuilder<ConfigRequestBuilder> {
     ...
     * @returns {Promise<QueryWikiFeishuConfigCommandResponse>}
     ...
     */
     get(requestConfiguration?: RequestConfiguration<ConfigRequestBuilderGetQueryParameters> | undefined) : Promise<QueryWikiFeishuConfigCommandResponse | undefined>;
    /**
     * 获取飞书配置详情.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export const ConfigRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createQueryWikiFeishuConfigCommandResponseFromDiscriminatorValue,
