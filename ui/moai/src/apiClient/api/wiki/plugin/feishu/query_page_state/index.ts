...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createQueryWikiFeishuPageTasksCommandResponseFromDiscriminatorValue, type BusinessValidationResult, type QueryWikiFeishuPageTasksCommandResponse } from '../../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/wiki/plugin/feishu/query_page_state
 */
...
export const Query_page_stateRequestBuilderRequestsMetadata: RequestsMetadata = {
    get: {
        ...
        responseBodyFactory:  createQueryWikiFeishuPageTasksCommandResponseFromDiscriminatorValue,
