...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createSimpleIntFromDiscriminatorValue, serializeImportPaddleocrDocumentCommand, serializeSimpleInt, type BusinessValidationResult, type ImportPaddleocrDocumentCommand, type SimpleInt } from '../../../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/wiki/plugin/paddleocr/import
 */
export interface ImportRequestBuilder extends BaseRequestBuilder<ImportRequestBuilder> {
    /**
     * 确认导入飞桨 OCR 解析的文档到知识库.
     * @param body 确认导入飞桨 OCR 解析的文档到知识库.
     ...
     */
     post(body: ImportPaddleocrDocumentCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<SimpleInt | undefined>;
    /**
     * 确认导入飞桨 OCR 解析的文档到知识库.
     * @param body 确认导入飞桨 OCR 解析的文档到知识库.
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
     ...
     */
     toPostRequestInformation(body: ImportPaddleocrDocumentCommand, requestConfiguration?: RequestConfiguration<object> | undefined) : RequestInformation;
}
/**
 * Uri template for the request builder.
 */
export const ImportRequestBuilderUriTemplate = "{+baseurl}/api/wiki/plugin/paddleocr/import";
/**
...
export const ImportRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        requestBodySerializer: serializeImportPaddleocrDocumentCommand,
