...
/**
 * Builds and executes requests for operations under /api/wiki/manager/update_wiki_config
 */
 ...
 */
export const Update_wiki_configRequestBuilderUriTemplate = "{+baseurl}/api/wiki/manager/update_wiki_config";
/**
