...
// @ts-ignore
import { createBusinessValidationResultFromDiscriminatorValue, createEmptyCommandResponseFromDiscriminatorValue, serializeEmptyCommandResponse, serializeUploadtUserAvatarCommand, type BusinessValidationResult, type EmptyCommandResponse, type UploadtUserAvatarCommand } from '../../../models/index.js';
// @ts-ignore
import { type BaseRequestBuilder, type Parsable, type ParsableFactory, type RequestConfiguration, type RequestInformation, type RequestsMetadata } from '@microsoft/kiota-abstractions';

/**
 * Builds and executes requests for operations under /api/user/upload_avatar
 */
 ...
 */
export const Upload_avatarRequestBuilderUriTemplate = "{+baseurl}/api/user/upload_avatar";
/**
