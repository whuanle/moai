...
/**
 * Builds and executes requests for operations under /api/admin_prompt/create_prompt
 */
 ...
 */
export const Create_promptRequestBuilderUriTemplate = "{+baseurl}/api/admin_prompt/create_prompt";
/**
