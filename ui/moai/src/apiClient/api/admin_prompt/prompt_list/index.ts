...
/**
 * Builds and executes requests for operations under /api/admin_prompt/prompt_list
 */
 ...
 */
export const Prompt_listRequestBuilderUriTemplate = "{+baseurl}/api/admin_prompt/prompt_list";
/**
