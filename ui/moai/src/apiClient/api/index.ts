...
// @ts-ignore
import { AaaaaaaaaaaaaaaaaaaaaaaRequestBuilderRequestsMetadata, type AaaaaaaaaaaaaaaaaaaaaaaRequestBuilder } from './aaaaaaaaaaaaaaaaaaaaaaa/index.js';
// @ts-ignore
...
export interface ApiRequestBuilder extends BaseRequestBuilder<ApiRequestBuilder> {
    /**
     * The aaaaaaaaaaaaaaaaaaaaaaa property
     */
    get aaaaaaaaaaaaaaaaaaaaaaa(): AaaaaaaaaaaaaaaaaaaaaaaRequestBuilder;
    /**
...
export const ApiRequestBuilderNavigationMetadata: Record<Exclude<keyof ApiRequestBuilder, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    aaaaaaaaaaaaaaaaaaaaaaa: {
        requestsMetadata: AaaaaaaaaaaaaaaaaaaaaaaRequestBuilderRequestsMetadata,
    },
    account: {
